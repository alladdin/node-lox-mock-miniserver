...
HttpServer.prototype.xml_response = function(response, message, code = 200) {
    this.send_response(response, message, code, 'text/xml');
};

HttpServer.prototype.json_response = function(response, message, code = 200) {
    this.send_response(response, message, code, 'application/json');
};

HttpServer.prototype.send_response = function(response, message, code = 200, type = 'text/plain') {
